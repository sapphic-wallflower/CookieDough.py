...
class Fun(commands.Cog):
    ...
    async def eight_ball(self, ctx, *args):
        ...
        CHOICES_8BALL = [
            ...
            'I\'m not so sure...Someone else here may know, however.',
            'It seems that there\'s other wisdom near... Someone else here knows best.',
            'Methinks the next person to say something about it will be correct.',
